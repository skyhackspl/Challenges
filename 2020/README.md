...
The dataset consists of two parts. One is a folder with photos from various parts of Silesia and a .csv file with the names of the photo files and a logical value for each of the 38 objects, determining whether it is in the photo. The second is a folder with video files.
...
Prepare .pdf presentation with statistics on how often objects of the classes listed in the first task are in the video files.
